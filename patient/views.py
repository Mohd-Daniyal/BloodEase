...
def patient_signup_view(request):
    ...
    if request.method=='POST':
        userForm=forms.PatientSignupForm(request.POST)
...
def patient_dashboard_view(request):
    ...
    dict={
        ...
        'username': models.Patient.objects.get(user_id=request.user.id).get_name,
    }
...
def update_patient_view(request):
    ...
    context = {
        ...
        'profilePic' : models.Patient.objects.get(user_id=request.user.id).profile_pic,
    }
...
def make_request_view(request):
    ...
    if request.method=='POST':
        ...
        if request_form.is_valid():
            ...
            patient= models.Patient.objects.get(user_id=request.user.id)
            blood_request.patient_name = patient.get_name
